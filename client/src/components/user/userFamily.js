    ...
    render() {
        ...
        const TreeButton = props => 
            <Button 
                ...
                style={{top: props.top, left: props.left, backgroundColor: props.color }} 
        ...
        return (
                <div className={classes.componentBox} >
                    ...
                    <div className={classes.treeContainer}>
                     ...
                     <Button type="button" className={classes.userNavButtonRight} onClick={() => this.handleNext()}>SAVE AND CONTINUE</Button>
