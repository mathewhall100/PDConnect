        ...
        return (
            <div>
                ...
                <h3 className={classes.textTitle}>Who Benefits Most ?</h3>
                    <p className={classes.text}>Patients with early or sudden unpredictable 'off' symptoms that occur depsite taking other Parkinson medications. Usually doctors will try to control 'off' symptoms by using other medicactions first but if this is not possible, or the other drugs are no longer working, then apomorphine can be a helpful treatment. </p>
                </div>
                ...
                <div>
                    ...
                    <p className={classes.text}>Apomorphine is not a treatment appropriate for all Parkinson patients but if you are having regular or sudden, unpredictable wear off symptoms not controlled by other medications, then it might be an option for you. Discuss with your doctor whether apomorphine is appropriate for you and particularly whether changes to your other Parkinson medications should be tried first to improve symptoms before considering apomorphine. Also discuss with your doctor the side effects oF apomorphine and how easy it will be for you to inject yourself or have a caregiver or family member do it for you.</p>
                </div>
