        ...
        return (
            <div>
                ...
                <div>
                    ...
                    <p className={classes.text}>Deep brain Stimulation (DBS) is a surgical procedure where electrodes are inserted into the area of the brain affected by Parkinons disease and which controls movement. These eletrodes send electrical signals into the brain to supress the abnormal nerve signals that give rise to Parkinson symptoms. DBS is an effective treatment for patients with disabling tremor, uncontrolled wearing off spells and medication-induced dyskinesia. While DBS is not a cure, many patients see considerable improvement in their motor symptoms and are able to reduce the amount of Parkinon medication they need to take. The benefits of DBS are known to last at least five years. </p>
                </div> 
                ...
                <div>
                    ...
                    <p className={classes.text}>As with any operation there are risks. In the case of DBS there is around a 3% chance (per side of the brain operated) of infection, bleeding and seizures. Cognitive decline is also seen in a small number of patients following DBS.   </p>
                </div>

                <hr />
                <div>
                    <h3 className={classes.textTitle}>What To Ask Your Doctor.</h3>
                    <p className={classes.text}>DBS is not offered to all patients and is currently only recommended for patients with poorly controlled motor symptoms  that cannot be controlled by medications. Check with your doctor that you have been diagnosed with Parkinson disease for more than four years and whether your symptoms can be improved with medications before considering DBS. Deciding an individual patients suitability for DBS usually requires specialist assessment and, if necessary, your doctor can refer you to a movement disorder specialist for this.   </p>
                </div>
                ...
                <h3 className={classes.textTitle}>Clinical Evidence Summary</h3>
                    <p className={classes.text}>Since introduction in 1997 to treat Parkinson tremor, successive clnical trials have shown benefit of DBS to broader groups of Parkinson patients until in 2016 DBS surgery was approved for patients in the earlier stages of disease but who still had uncontrolled symptoms.  </p>
                </div>
                ...
                <div>
                    ...
                    <p className={classes.text}>DBS is a prodcut of Medtronic  and more information can be found on their website: medtronic.com</p>
                </div>
            </div>
        )
    }
